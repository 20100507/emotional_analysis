            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu" >
                    ...
                    <ul class="sub">
                        <li><a href="${pageContext.request.contextPath }/graph/graphTop" class="active">用户PageRankTop榜</a></li>
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th>昵称</th>
            <th>用户ID</th>
            <th data-breakpoints="xs">排名比率</th>
          </tr>
        </thead>
        <tbody>
         <c:forEach items="${graphTopList }" var="graphTop">
         	 <tr data-expanded="true">
	            <td>${graphTop.graphtopIp }</td>
	            <td>${graphTop.userId }</td>
	            <td>${graphTop.name }</td>
	            <td>${graphTop.top }</td>
             </tr>
         </c:forEach>
