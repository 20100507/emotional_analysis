                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu" >
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="${pageContext.request.contextPath }/graph/graphTriangle" class="active" >用户Triangle榜</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th>用户昵称</th>
            <th>用户ID</th>
            <th data-breakpoints="xs">相关联triangle数量</th>
          </tr>
        </thead>
        <tbody>
        <c:forEach items="${graphTriangle }" var="triangle">
          <tr data-expanded="true">
            <td>${triangle.triangleId }</td>
            <td>${triangle.name }</td>
            <td>${triangle.userId }</td>
            <td>${triangle.triangleTop}</td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
