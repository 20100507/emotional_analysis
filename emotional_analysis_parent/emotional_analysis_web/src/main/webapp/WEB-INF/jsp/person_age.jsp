            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="${pageContext.request.contextPath }/person/age" class="active" >年龄分布</a></li>
                    </ul>
                </li>
				 <li class="sub-menu">
                    <a href="javascript:;">
...
<section id="main-content">
	<section class="wrapper">
		<iframe name="content_frame" marginwidth=0 marginheight=0 width=100% height=650px src="${pageContext.request.contextPath }/age-labels.html" frameborder=0></iframe>        
