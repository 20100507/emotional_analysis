            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="${pageContext.request.contextPath }/person/gender"  class="active" >性别比例</a></li>
...
<section id="main-content">
	<section class="wrapper">
		<iframe name="content_frame" marginwidth=0 marginheight=0 width=100% height=650px src="${pageContext.request.contextPath }/gender-labels.html" frameborder=0></iframe>        
