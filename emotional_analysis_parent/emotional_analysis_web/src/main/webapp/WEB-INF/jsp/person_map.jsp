        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="${pageContext.request.contextPath }/person/map" class="active">全国地理分布</a></li>
...
<section id="main-content">
	<section class="wrapper">
		<font color="red" size="5px;">网易云音乐用户全国分布图</font>
		<iframe name="content_frame" marginwidth=0 marginheight=0 width=100% height=650px src="${pageContext.request.contextPath }/map-labels.html" frameborder=0></iframe>        
