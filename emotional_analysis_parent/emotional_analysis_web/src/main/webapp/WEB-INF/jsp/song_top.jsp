        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="${pageContext.request.contextPath }/song/songtop" class="active">热歌排行榜</a></li>
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th>歌曲名称</th>
            <th>歌手</th>
            <th data-breakpoints="xs">评论数量</th>
          </tr>
        </thead>
        <tbody>
         <c:forEach items="${songTopList }" var="songTop">
         	 <tr data-expanded="true">
	            <td>${songTop.songTop }</td>
	            <td>${songTop.songName }</td>
	            <td>${songTop.singerName }</td>
	            <td>${songTop.songCount }</td>
             </tr>
         </c:forEach>
        </tbody>
      </table>
