            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="${pageContext.request.contextPath }/comment/wordcloud"  class="active">评论词云</a></li>
                ...
                <li class="sub-menu">
				 ...
				 <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-tasks"></i>
                        <span>机器学习mlib[分类/聚类]</span>
                    </a>
                    <ul class="sub">
                        <li><a href="form_component.html">训练情感模型</a></li>
                        <li><a href="form_validation.html">预测歌曲</a></li>
                    </ul>
                </li>
            </ul>
            </div>
...
<section id="main-content">
	<section class="wrapper">
		...
		<div style="color:red;font-size: 30px;">网易云音乐评论词云</div>
        <div id='main'></div>
        </div>
        <script>
            ...
            var data = [];
       	　　$("#main").click(function(){ 
       	　　 $.get("${pageContext.request.contextPath}/comment/comment_word", 
       	    function(result){
       		$.each(result, function (i, item) { 
       			data.push({
                    name: item.content,
                    value: Math.sqrt(item.contentCount)
                })
            });
       	　　});
       	});
            ...
            maskImage.src = '${pageContext.request.contextPath }/images/logo.png';
        </script>
