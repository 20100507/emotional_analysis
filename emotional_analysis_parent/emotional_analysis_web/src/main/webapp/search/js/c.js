...
// These are "sizes" for exoclick ads that include the associated zone ID.
var exoclickAdSizes = [
  [728,  90, 2803192],
  [468,  60, 2857920],
  [300, 250, 2857924],
...
var activeAdSizes = exoclickAdSizes;

var adSwapRate = 0.01; // 0.01 = 1 percent
var maxAdsPerPage = 1;
var maximumAllowedSizeRatio = 3;
var targetURL = {"Scheme":"http","Opaque":"","User":null,"Host":"localhost:49854","Path":"","RawPath":"","ForceQuery":false,"RawQuery":"token=1784bbc417e08f2c4b282d3df6535007","Fragment":"/plans"};
var lang = 'zh';

function candidatesFor(targetSize) {
  var candidates = [];
  activeAdSizes.forEach(function(adSize) {
...
function lanternAdFor(size) {
  ...
  // If the source ad contains zone info, use it.
  var sourceZone = srcSize.length > 2 ? srcSize[2] : 0;
  ...
  var iframeSrc = `<div style="width: ${sourceWidth}px; height: ${sourceHeight}px; position: relative; margin: -${sourceHeight/2}px auto 0 auto; top: 50%;">
      <script type="text/javascript">
      var ad_idzone = "${sourceZone}",
      	 ad_width = "${sourceWidth}",
      	 ad_height = "${sourceHeight}";
      </script>
      <script type="text/javascript" src="https://ads.exdynsrv.com/ads.js"></script>
      <noscript><a href="https://main.exdynsrv.com/img-click.php?idzone=${sourceZone}" target="_blank"><img src="https://syndication.exdynsrv.com/ads-iframe-display.php?idzone=${sourceZone}&output=img&type=${sourceWidth}x${sourceHeight}" width="${sourceWidth}" height="${sourceHeight}"></a></noscript>
    </div>
